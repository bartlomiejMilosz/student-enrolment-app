...
public class ExceptionControllerAdvice {
    ...
    private Map<String, Object> getResponseBody(HttpServletRequest request, HttpStatus httpStatus, String massage) {
    ...
    public ResponseEntity<Object> handleIndexOutOfBoundsException(
    ...
    public ResponseEntity<Object> handleMessageNotReadableException(
        ...
        Map<String, Object> body = getResponseBody(
                ...
                "The request message is not readable."
        );
        return ResponseEntity
